...
namespace CodeBattleNetLibrary
{
    ...
    public class ActionPrinter
    {
        ...
        public static String printAction(FireOrder? fireOrder, Direction? direction)
        {
            if (direction == null)
            {
                ...
                switch (fireOrder)
                {
                    case FireOrder.FIRE_AFTER_TURN:
                        return "ACT(1)";
                    case FireOrder.FIRE_BEFORE_TURN:
                        return "ACT";
                }
            }
        ...
        public class GameClientBattlecity
    {
        ...
        public GameClientBattlecity(string url, Func<GameClientBattlecity, String> action)
        {
            MapSize = 0;
            ...
            this.Run(() =>
            {
                String actions = action.Invoke(this);
            ...
            _socket.Closed += (s, e) => { 
                ...
                Console.Error.WriteLine("Waiting for reconnect");
                Thread.Sleep(5000);
                Console.Error.WriteLine("Reconnect");
                new GameClientBattlecity(url, action);
            };
        ...
        private void ParseField(string rawField)
        {
            ...
            {
                //Console.WriteLine(rawField.Substring(j * size, size));
